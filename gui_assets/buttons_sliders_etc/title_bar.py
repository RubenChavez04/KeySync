...
class TitleBar(QWidget):
    ...
    def __init__(self, parent):
        ...
        # give the minimize button a custom icon
        min_icon = QIcon()
        # give it a directory to the icon file
        min_icon.addFile("gui_assets/gui_icons/Minus-256.ico")
        self.min_button.setIcon(min_icon)
        # if minimize is pressed minimize the program, don't worry about the connect being underlined
        # it's just a pycharm bug
