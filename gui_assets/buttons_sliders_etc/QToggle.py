...
class QToggle(QCheckBox):
    ...
    def __init__(self, parent=None):
        ...
        self._bg_color, self._circle_color, self._active_color, \
            ...
            QColor("#DDD"), QColor('#57965c'), QColor("#c94f4f"), QColor("#000")
    ...
    def update_pos_color(self, checked=None):
        self._circle_pos = self.height() * (4.45 if checked else 0.1)
        if self.isChecked():
    ...
    def create_animation(self, state):
        return self._create_common_animation(
            state, b'circle_pos', self.height() * 0.1, self.height() * 4.45)
...
if __name__ == '__main__':
    ...
    checkbox0.stateChanged.connect(toggled)
